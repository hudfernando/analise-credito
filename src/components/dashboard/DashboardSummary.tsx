...
import { Users, Star, DollarSign, HelpCircle, ShieldCheck, Scale } from "lucide-react";
  ...
  if (isLoading && !summaryData) {
    return (
      <div className="space-y-4">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">{[...Array(4)].map((_, i) => <Skeleton key={i} className="h-[105px] w-full" />)}</div>
