      ...
      <PopoverContent className="w-96" align="end">
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            <div className="font-bold text-red-500">Score de Risco</div>
            <p className="text-sm text-muted-foreground">
              Avalia a probabilidade de inadimplência.
            </p>
            <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
              ...
              <li>
                <strong className="text-sky-600">⭐ Bônus do Bom Pagador:</strong> Se o cliente não tem títulos vencidos, o risco associado à <strong>Utilização do Limite</strong> é reduzido.
              </li>
            </ul>
          </div>

          <div className="grid gap-2">
            <div className="font-bold text-green-500">Score de Valor</div>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="grid gap-2">
            <div className="font-bold">Classificação Final</div>
